<?php /* Smarty version 2.6.26, created on 2017-04-18 19:55:36
         compiled from D:/www/hailun/web/360/Admin/View/List/notask.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'D:/www/hailun/web/360/Admin/View/List/notask.html', 29, false),)), $this); ?>
...
$this->_sections['num']['loop'] = is_array($_loop=$this->_tpl_vars['notask']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
		<tr>
			...
			<td><?php echo $this->_tpl_vars['notask'][$this->_sections['num']['index']]['asid']; ?>
</td>
			<td><?php echo $this->_tpl_vars['notask'][$this->_sections['num']['index']]['content']; ?>
</td>
			<td><?php echo ((is_array($_tmp=$this->_tpl_vars['notask'][$this->_sections['num']['index']]['time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d %S:%M:%S") : smarty_modifier_date_format($_tmp, "%Y-%m-%d %S:%M:%S")); ?>
</td>
			<td><?php echo $this->_tpl_vars['notask'][$this->_sections['num']['index']]['answer']; ?>
</td>
			<td><?php echo $this->_tpl_vars['notask'][$this->_sections['num']['index']]['reward']; ?>
</td>
			<td>
				<a href="<?php echo @__APP__; ?>
?c=list&a=notask&asid=<?php echo $this->_tpl_vars['notask'][$this->_sections['num']['index']]['asid']; ?>
" class="del">删除</a>
			</td>
		</tr>
		<?php endfor; endif; ?>
