<?php /* Smarty version 2.6.26, created on 2015-06-01 21:12:17
...
?c=member"><?php echo $_SESSION['name']; ?>
</a></li>
            <li><a href="<?php echo @__APP__; ?>
...
?c=search" method='post'>
         <input type="text" name='result' class='sech-cons' value="" />
...
?>
            <li>
               <a href="<?php echo @__APP__; ?>
?c=category&cid=<?php echo $this->_tpl_vars['value']['cid']; ?>
"><?php echo $this->_tpl_vars['value']['title']; ?>
   ...
   <p class='total'>累计提问：<?php echo $this->_tpl_vars['cont']; ?>
</p>
</div>
