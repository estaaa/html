<?php /* Smarty version 2.6.26, created on 2015-06-01 13:12:36
         compiled from D:/wamp/www/www/2/up/Index/View/Search/index.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'D:/wamp/www/www/2/up/Index/View/Search/index.html', 41, false),)), $this); ?>
...
" class="title"><?php echo $this->_tpl_vars['v']['content']; ?>
</a> </li>
			<li><?php echo $this->_tpl_vars['v']['da']; ?>
.....</li>
			<li class="time"><span><?php echo $this->_tpl_vars['v']['title']; ?>
 - <?php echo $this->_tpl_vars['v']['answer']; ?>
个回答</span> - 提问时间: <?php echo ((is_array($_tmp=$this->_tpl_vars['v']['time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%y-%m-%d %H:%M:%S") : smarty_modifier_date_format($_tmp, "%y-%m-%d %H:%M:%S")); ?>
</li>
		</ul>
