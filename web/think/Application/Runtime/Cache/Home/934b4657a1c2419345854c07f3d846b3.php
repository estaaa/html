...
<div id="user-right">
         <!-- 我的评价 -->
                <div id="user-refund">
                    <div class="header">
                        <span>商品评价</span><!-- <a href="" class="clo">三个月之前商品</a><a href="">最近三个月商品</a> -->
                    </div>
                    <div class="no-payment">
                      <p><span style="width:300px">商品标题</span><span style="width:300px">评价内容</span><span style="width:300px">操作</span></p>
                      <?php if(is_array($appData)): $k = 0; $__LIST__ = $appData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><div class="payment-box">
                        
                        <div class="k kd" style="width:300px"><a href=""><?php echo ($v["p_title"]); ?></a></div>
                        <div class="k kd2" style="width:300px"><a href=""><?php echo ($v["app_content"]); ?></a></div>
                        <div class="k kd3" style="width:300px"><a href="<?php echo U('Home/User/del',array('app_id'=>$v['app_id']));?>">删除</a></div>
