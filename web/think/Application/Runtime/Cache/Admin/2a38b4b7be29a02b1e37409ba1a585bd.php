...
$(".tip").fadeIn(200);
  ...
  $(".sure").click(function(){
    location.href="<?php echo U('Admin/Brand/del');?>?bid="+num;
  $(".tip").fadeOut(100);
});
...
<body>
    ...
    <table class="tablelist">
        ...
        <th>品牌id<i class="sort"><img src="/hailun/web/think/Public/Admin/images/px.gif" /></i></th>
        <th>品牌名称</th>
        <th>LOGO</th>
        <th>排序</th>
        ...
        <th style="width:270px;" text-align="center">操作</th>
         ...
         <?php if(is_array($allData)): $i = 0; $__LIST__ = $allData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tbody class="fat">
                ...
                <td><img height="80px" width="80px" alt="" <?php if($v['logo']): ?>src="/hailun/web/think/Uploads/<?php echo ($v["logo"]); ?>" <?php else: ?> src="/hailun/web/think/Public/Admin/images/adminlogo.jpg"<?php endif; ?> ></td>
                <td><?php echo ($v["sort"]); ?></td>
               
                <td>
                  
                    <a href="<?php echo U('edit',array('bid'=>$v['bid']));?>" class="btn btn-primary" style="text-align: center;" >编辑</a>
                    
                    <a href="javascript:del(<?php echo ($v["bid"]); ?>);" class="btn btn-danger click">删除</a>
                </td>
